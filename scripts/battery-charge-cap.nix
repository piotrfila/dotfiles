...
pkgs.writeShellScriptBin "battery-charge-cap" ''
  ...
  icon="${pkgs.faba-icon-theme}/share/icons/Faba/24x24/panel/gpm-battery-$icon-charging.svg"
  ${pkgs.libnotify}/bin/notify-send -i $icon -t 2000 --replace-id=557 "Ustawiono limit naładowania baterii na $disp%"
''